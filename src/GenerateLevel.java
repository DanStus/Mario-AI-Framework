...
//        MarioGame game = new MarioGame();
        ...
        String level = (new levelGenerators.LeandresStusalitusGenerator.LevelGenerator(LevelGenerator.LevelType.RANDOM, 1)).getGeneratedLevel(new MarioLevelModel(400, 16), new MarioTimer(5 * 60 * 60 * 1000));
        MarioGame game = new MarioGame();
